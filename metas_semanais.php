...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/metas_semanais.css">
    ...
    <body>
        ...
        <main class="container-fluid">
            <div class="row justify-content-center text-center row-edit">
                <h2 class="semana">Metas da Semana</h2>
            </div>
            <div class="row">
                <div class="col-lg-2">
                ...
                <div class="col-lg-8">
                    <div class="row row-edit">
                        <button class="button_img" onclick="formulario(2)"><img class="img_button" src= "imgs/mais.png" width="20px"></button>
                    </div>
                    <div class="row row-edit">
                        <section>
                            <ul id="lista_metas">
